...
class MainWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        uic.loadUi("/home/celis/Documents/projects/trunk/escan/simulators/PowerSupply/Files/untitled.ui",self)
    ...
    def start_server(self):
        server_data = readJson(
            '/home/celis/Documents/projects/trunk/escan/simulators/PowerSupply/config/soil_moisture_config.json')
        ip_address = server_data['server']['ip']
        port = server_data['server']['port']
        self.server = socketserver.TCPServer((ip_address, port), PowerSupplyTCPHandler)
